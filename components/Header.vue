<template>
    <div class="relative bg-white">
            ...
            <div class="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                ...
                <nav class="hidden space-x-10 md:flex">
                    <div class="relative">
                        ...
                        -->
                        <div
                            class="absolute z-10 -ml-4 mt-3 w-screen max-w-md transform px-2 transition-all sm:px-0 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2 "
                            :class="showSolutions
                                ? 'opacity-100 translate-y-0 ease-out duration-200'
                                : 'opacity-0 translate-y-1 invisible ease-in duration-150'
                            "
                        >
                    ...
                    <div class="relative">
                        ...
                        -->
                        <div
                            class="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transition-all transform px-2 sm:px-0"
                            :class="showMore
                                ? 'opacity-100 translate-y-0 ease-out duration-200'
                                : 'opacity-0 translate-y-1 invisible ease-in duration-150'
                            "
                ...
                <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                    ...
                    <a href="#" class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">
                        Sign up
                    </a>
                </div>
            </div>
        ...
        -->
        <div
            class="absolute inset-x-0 top-0 origin-top-right transform p-2 transition-all md:hidden z-10"
            :class="showMobileMenu
                ? 'opacity-100 duration-200 ease-out'
                : 'opacity-0 left-full duration-100 ease-in'
            "
        >
...
const showSolutions = useState(() => false);
